...
TeraTerm Menu 1.22 (2026.04.28)

・Ver 1.20 以前でレジストリに保存された設定を読み込んだとき、強制的に LockBox が使用される場合がある不具合を修正した。 1.20 からの不具合。 (issue #1223)
・TeraTerm Menu で指定した "Tera Term 設定ファイル" が読み込まれない不具合を修正した。 1.21 からの不具合。 (issue #1157)
・"起動時に実行する" が機能しなくなっていた不具合を修正した。 1.21 からの不具合。 (issue #1251)
・リスト編集ダイアログの "起動の種類" のラジオボタンが「"autologin"」と「"specified macro file"と"launch only"」の2グループに分かれていた不具合を修正した。 1.20 からの不具合。 (issue #1169)
・リスト編集ダイアログの "use SSH" が "specified macro file" と "launch only" 選択時に有効になっていた不具合を修正した。 1.18 からの不具合。 (issue #1169)
・ファイル名に '"' ではじまる文字が入力された状態で、ファイル選択ダイアログを開いて閉じた時、不正なアドレスを free() する不具合を修正した。 (issue #1176)

TeraTerm Menu 1.21 (2025.11.25)
